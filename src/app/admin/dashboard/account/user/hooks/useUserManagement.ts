          ...
          if (!statistics) {
            ...
            setStatistics({
              overview: {
                total: pager?.total || userData.length,
                active: activeCount,
                inactive: userData.filter((u: User) => u.status === 'inactive')
                  .length,
                locked: userData.filter((u: User) => u.status === 'locked')
                  .length,
                activeRate:
                  userData.length > 0
              ...
              engagement: {
                recentLogins: userData.filter((u: User) => u.lastLoginAt)
                  .length,
                recentLoginRate:
                  userData.length > 0
                    ? Math.round(
                        (userData.filter((u: User) => u.lastLoginAt).length /
                          userData.length) *
                          100 *
                          100
                      ) / 100
              ...
              growth: {
                thisMonth: userData.filter((u: User) => {
